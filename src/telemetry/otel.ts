...
export const SpanName = {
  ...
  SessionQuiesce: "session.quiesce",
  SessionCascade: "session.cascade",
...
export const Attr = {
  ...
  HasPendingAsk: "relay.session.has_pending_ask",
  DropReason: "relay.session.drop_reason",
  ReuseScope: "relay.reuse.scope",
  CascadeDepth: "relay.session.cascade_depth",
